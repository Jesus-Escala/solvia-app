/** 18 color families × 10 shades (light to dark), the same palette as TSI's input-color. */
...
/** Text that reads on a background color: dark on light colors, white on dark ones. */

...
export const en: Messages = {
  ...
  labels: {
    ...
    chosen: '{count|# product chosen|# products chosen}',
    clear: 'Remove all',
    none: 'Choose the products from the list.',
    per: 'per {unit}',

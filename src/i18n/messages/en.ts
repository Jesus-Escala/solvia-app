...
export const en: Messages = {
  ...
  reports: {
    ...
    names: {
      ...
      'sales-by-customer': 'Best customers',
      'sales-by-product': 'Best sellers',
      'sales-by-category': 'By category',
      'sales-by-method': 'By payment method',
      'sales-by-seller': 'By seller',
      'purchases-detail': 'Purchases detail',
      'purchases-by-supplier': 'By supplier',
      'purchases-by-product': 'Products bought',
    ...
    hints: {
      'sales-detail':
        'Every sale with its time, customer, products, how it was paid, discount, balance and who made it (voided ones too, marked).',
      'sales-by-day': 'How much you sold each day: sales, cash, on credit and average ticket.',
      'sales-by-category': 'Which categories sell the most and how much you make on each.',
      'sales-by-method': 'How much came in cash, Yape, Plin, transfer and how much was on credit.',
      'sales-by-seller': 'How much each user of your team sold.',
      'purchases-detail':
        'Every purchase with its supplier, products, how you paid, receipt and who recorded it.',
      'purchases-by-supplier': 'How much you bought from each supplier and when was the last time.',
      'purchases-by-product':
        'Which products you bought, how much you spent, their average and last cost.',
  ...
  dashboard: {
    ...
    tabs: {
      ...
      hints: {
        sales: 'How much you sold, best sellers, your best customers, how they pay and when.',
        purchases: 'How much you bought, from which suppliers, which products and how you paid.',
    ...
    sales: {
      answer:
        'In those dates you sold ⟦{total}⟧ in ⟦{sales} sales⟧, with an average ticket of ⟦{average}⟧.',
      answerEmpty: 'No sales in those dates. Try another period.',
      ...
      kpis: {
        ...
        profitHint: 'With the current cost of each product.',
        credit: 'Sold on credit',
      },
      byDay: 'Sales by day',
      byDayHint: 'What you sold each day, cash and on credit.',
      topProducts: 'Best sellers',
      topProductsHint: 'The 10 products that brought you the most money.',
      topCustomers: 'Your best customers',
      topCustomersHint: 'Who bought the most from you in those dates.',
      methods: 'How they pay you',
      methodsHint: 'Cash, Yape, Plin, transfer and what was sold on credit.',
      categories: 'By category',
      categoriesHint: 'Which kind of products sells the most.',
      hours: 'When you sell',
      hoursHint: 'Your busiest hours (the strongest one highlighted).',
      inSales: '{count|# sale|# sales}',
      purchases: '{count|# purchase|# purchases}',
      walkIn: 'Also, {count|# sale|# sales} to walk-in customers for {amount}.',
      empty: 'No sales in those dates.',
      noCustomers: 'No sale had a customer recorded in those dates.',
    },
    purchases: {
      answer: 'In those dates you bought ⟦{total}⟧ in ⟦{purchases} purchases⟧.',
      answerEmpty: 'No purchases in those dates. Try another period.',
      kpis: {
        bought: 'You bought',
        purchases: 'Purchases',
      ...
      byDay: 'Purchases by day',
      byDayHint: 'What you spent on goods each day.',
      suppliers: 'Who you buy from',
      suppliersHint: 'Your main suppliers.',
      products: 'What you buy the most',
      productsHint: 'The products you spent the most on.',
      methods: 'How you paid',
      methodsHint: 'Of the purchases where you recorded how you paid.',
      count: '{count|# purchase|# purchases}',
      empty: 'No purchases in those dates.',
      noMethods: 'Those purchases did not record how you paid.',
    },
    today: {
      title: 'For today',
  ...
  scanner: {
    button: 'Scan QR',
    open: 'Scan the QR or the barcode',
    title: 'Scan QR',
    hint: 'Point at the QR or the barcode: each product read is added and the camera stays ready for the next one.',
    starting: 'Turning the camera on…',
    waiting: 'Looking for a code…',
    read: 'Read: {code}',
    added: '{name} added',
    notFound: 'No product has the code {code}',
    count: '{count|# product added|# products added}',
    done: 'Done',
    errors: {
      denied:
  ...
  pos: {
    ...
    info: {
      open: 'See details',
      openNamed: 'See the details of {name}',
      alertAt: 'alert at {count}',
      pack: 'Bought in sacks / boxes of',
      sold: 'Last 90 days',
      soldCount: '{count|in # sale|in # sales}',
      addSale: 'Add to the sale',
      addPurchase: 'Add to the purchase',
    },
    newButtonTitle: 'New product or service (saved to your products)',
    create: 'Create “{text}”',
  ...
  sales: {
    ...
    form: {
      ...
      receivedShort: '{amount} short with what they pay. Check the amount or choose “Several”.',
    ...
    ticket: {
      ...
      greeting: 'Hi {name}, here is the ticket of your purchase:',
      view: 'See ticket',
      print: 'Print',
      send: 'WhatsApp',
      download: 'Download',
  ...
  purchases: {
    ...
    new: 'New purchase',
    ticket: 'Purchase No. {number}',
    viewTicket: 'See record',
    ...
    form: {
      ...
      paidWith: 'How did you pay?',
      missingCost: 'A product is missing its cost.',
      supplier: 'Supplier',
  ...
  locations: {
    title: 'Locations',
    description: 'Upload the floor plan of your business and mark where each product is.',
    maps: 'Floor plans',
    loadError: 'The floor plans could not be loaded. Check your connection and try again.',
    newMap: 'New floor plan',
    renameMap: 'Rename',
    mapName: 'Floor plan name',
    mapNamePlaceholder: 'E.g. Shop, Storeroom, Second floor',
    mapImage: 'Floor plan picture',
    mapImageHint:
      'A photo or drawing of the plan seen from above (JPG, PNG or WEBP). You can upload it later.',
    chooseImage: 'Choose picture',
    uploadImage: 'Upload picture',
    changeImage: 'Change floor plan picture',
    removeImage: 'Remove picture',
    deleteMap: 'Delete floor plan',
    mapCreated: 'Floor plan created',
    mapRenamed: 'Name updated',
    mapDeleted: 'Floor plan deleted',
    confirmDeleteMapTitle: 'Delete this floor plan?',
    confirmDeleteMapMessage:
      '"{name}" is deleted with {count|# location|# locations}. The products stay, without a location.',
    uploading: 'Uploading the floor plan…',
    imageUploaded: 'Floor plan updated',
    imageRemoved: 'Picture removed',
    imageInvalid: 'That picture could not be read. Try a JPG or PNG photo.',
    empty: {
    ...
    cancelMark: 'Cancel',
    hint: {
      flat: 'Drag to move the plan',
      flatEdit: 'Drag an area to move it · its corner to resize it',
      depth: 'Drag to turn · wheel or pinch to zoom',
      mark: 'Drag on the plan to draw the area (or tap for a small one)',
    },
    zoomIn: 'Zoom in',
    zoomOut: 'Zoom out',
    reset: 'See the whole plan',
    rotateLeft: 'Turn left',
    rotateRight: 'Turn right',
    search: 'Where is it? Search a product or place',
    spots: 'Locations on this plan',
    found: 'Found it here',
    noSpots: 'No locations yet. Tap "Mark a location" and draw the area on the plan.',
    pane: { label: 'Show', map: 'Plan', list: 'List' },
    seeProducts: 'See products',
    noMatches: 'No place on this plan has "{text}".',
    productsCount: '{count|# product|# products}',
    allSpots: 'All locations',
    spot: {
      new: 'New location',
      edit: 'Edit location',
      name: 'Name of the place',
      namePlaceholder: 'E.g. Shelf A, Fridge, Display case',
      color: 'Color',
      colorHint: 'Pick one or tap the box to see every color.',
      created: 'Location marked',
      updated: 'Location updated',
      moved: 'Location moved',
      deleted: 'Location deleted',
      confirmDeleteTitle: 'Delete this location?',
      confirmDeleteMessage:
        '"{name}" is removed from the plan. {count|Its product stays|Its # products stay} without a location.',
      addPlaceholder: 'Add product: code or description',
      addHint: 'Type the code or the name of the product.',
      noResults: 'No products with "{text}".',
      noProducts: 'No products in this place yet. Search them above to add them.',
  ...
  labels: {
    ...
    description:
      'To stick on your products or on the shelves. Scanning them adds them to the sale.',
    search: 'Search products…',
    pickAll: 'Select all ({count})',
    pickFound: 'Select the ones found ({count})',
    unpickAll: 'Clear the selection',
    chosenOf: '{chosen} of {count}',
    noProducts: 'No products with that name.',
    more: 'And {count|# more|# more}: search them by name or use “Select all”.',
    copies: 'Quantity',
    size: 'Size',
    sizes: {
      shelf: 'Shelf',
      shelfHint: '80 × 50 mm · big price',
      product: 'Product',
      productHint: '50 × 30 mm · to stick on',
    },
    paper: 'Where you print',
    papers: {
      sheet: 'A4 sheet',
      sheetHint: 'Several labels per sheet, with lines to cut (or on adhesive sheets).',
      roll: 'Label printer',
      rollHint: 'One label per page, of the chosen size (thermal rolls).',
    },
    per: 'per {unit}',
    print: 'Print {count|# label|# labels}',
    tooMany: 'At most {count} labels are printed at a time.',
  },
  products: {
    ...
    form: {
      ...
      qrCode: 'Item code (its QR)',
      qrAuto: 'When you save it, Solvia creates its unique QR code.',
  ...
  split: {
    ...
    method: 'Method',
    add: 'Another method',
    remove: 'Remove this method',
    complete: 'Complete',
    missing: '{amount} missing',
    over: '{amount} over',
    sum: 'Total {amount}',
    hint: 'For example, part in cash and the rest with Yape.',
    notComplete: 'The amounts do not add up to {amount}. Check them.',
    toggle: 'Paid with several methods',
    single: 'Paid with one method',
    paidWith: 'Paid with',
    youPaidWith: 'You paid with',
  },
  payment: {
    title: 'Paid me',
    noAmount: 'Type how much they paid.',
    tooMuch: 'It is more than they owe ({amount}).',
